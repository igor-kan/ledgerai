# Contributing to ledgerai

Thank you for your interest in contributing to ledgerai! This document provides guidelines and instructions for contributing to this project.
...
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/ledgerai.git
   ```
...
By contributing to ledgerai, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
